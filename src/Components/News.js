...
export class News extends Component {
  ...
  {
    let url = "https://newsapi.org/v2/everything?q=movies&apiKey=5358deef8dbf46fc884374ca4d034c3f&page=1&pageSize=18";
  ...
  handlePrevClick = async() => {
    ...
    let url = `https://newsapi.org/v2/everything?q=movies&apiKey=5358deef8dbf46fc884374ca4d034c3f&page=${this.state.page-1}&pageSize=18`;
    let data = await fetch(url);
    let parsedData = await data.json()
    console.log(parsedData);
